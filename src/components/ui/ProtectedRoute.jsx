...
const ProtectedRoute = ({ children }) => {
  ...
  try {
    ...
    if (clerk && typeof clerk.isLoaded !== 'undefined') {
      ...
      if (!clerk.isSignedIn) return <Navigate to="/login" state={{ from: location }} replace />;
      return children;
    }
  } catch (e) {
    // useUser may throw if ClerkProvider isn't configured; fall back to Firebase auth
  }
